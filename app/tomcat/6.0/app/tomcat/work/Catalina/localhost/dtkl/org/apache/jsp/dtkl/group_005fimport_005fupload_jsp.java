 ...
 * Generated at: 2016-04-14 03:30:37 UTC
...
public final class group_005fimport_005fupload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    StaffSessBean staffSessBean= SessionInfoUtil.getStaffSessBean(request.getSession());
    Boolean isAdmin=staffSessBean.isAdmin();
    String userName=staffSessBean.getUserName();
    object = module.groupImport(trace,groupName,groupType,userId,userName,isAdmin);
	out.println("<script>parent.uploadTip(" + object + ")</script>");
	
	// 记录操作日志
	String logContent = "新增关注人群，保存内容：groupName:" + groupName + "，groupType:"+groupType;
	String funcId = "warnConfig";
	 staffSessBean = SessionInfoUtil.getStaffSessBean(session);
	LogDSUtil.insertOperatorLog(staffSessBean, logContent, funcId);
