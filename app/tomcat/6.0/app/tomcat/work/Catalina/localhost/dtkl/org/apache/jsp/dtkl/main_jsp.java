 ...
 * Generated at: 2016-04-15 03:18:05 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/dtkl/../common/jsp/common.jsp", Long.valueOf(1460711902000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String DATA_SOURCE = InitParam.DATA_SOURCE;
      ...
      out.write("<link href=\"http://api.map.baidu.com/library/DrawingManager/1.4/src/DrawingManager_min.css\"    rel=\"stylesheet\" type=\"text/css\">\r\n");
      out.write("<script src=\"http://api.map.baidu.com/getscript?v=2.0&ak=sGZOkeDdDDh55kIiuYC2qUg1&services=&t=20150818132813\"></script>\r\n");
      out.write("<script src=\"");
      out.print(GlobalValues.CONTENT_PATH);
      out.write("/dtkl/assets/js/BaiduMap/AreaRestriction_min.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(GlobalValues.CONTENT_PATH);
      out.write("/dtkl/assets/js/BaiduMap/BMapDrawingManager.js\"></script>\r\n");
      out.write("<script src=\"");
      out.print(GlobalValues.CONTENT_PATH);
      out.write("/dtkl/assets/js/BaiduMap/BMapLib_GeoUtils.js\"></script>\r\n");
      out.write("<script>\r\n");
      out.write("    var cmcc_source='");
      out.print(InitParam.DATA_SOURCE_CMCC );
      out.write("';\r\n");
      out.write("    var all_source='");
      out.print(InitParam.DATA_SOURCE_ALL);
      out.write("';\r\n");
      out.write("    var DATA_SOURCE='");
      out.print(InitParam.DATA_SOURCE);
      out.write("';\r\n");
      out.write("\trequires([\"baiduMap\",\r\n");
      out.write("\t          \"dtkl\",\r\n");
      out.write("\t          \"base\",\r\n");
      out.write("\t          \"echarts\",\r\n");
      out.write("\t          \"laydate\",\r\n");
      out.write("\t          \"/dtkl/warn_unknown_regionInit.js\",\r\n");
      out.write("\t          \"/dtkl/main.js\"\r\n");
      out.write("\t         ]);\r\n");
      out.write("</script>\r\n");
      ...
      out.write(" function showSpanTime(){\r\n");
      out.write("\t $(\"#new_date\").css(\"display\",\"inline\");\r\n");
      out.write(" }\r\n");
      out.write(" function hideSpanTime(){\r\n");
      out.write("\t $(\"#new_date\").css(\"display\",\"none\");\r\n");
      out.write(" }\r\n");
      out.write(" function reload(){\r\n");
      out.write("\tlocation.reload(true);\r\n");
      out.write(" }\r\n");
      out.write(" function addCookie(){\r\n");
      out.write("\t var istingxing=$(\"#tingxingCheck\").is(\":checked\");\r\n");
      out.write("\t document.cookie=\"isChecked=\"+istingxing;\r\n");
      out.write(" }\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body  id='bodyPanel'>\r\n");
      out.write("<div class=\"content\">\r\n");
      out.write("    <div class=\"mask_div\"></div>\r\n");
      out.write("\t<div class=\"box\">\r\n");
      out.write("\t\t<div class=\"leftBox loadingSmall\">\r\n");
      out.write("\t\t\t<div class=\"left_title_new\">\r\n");
      out.write("\t\t\t\t<div class=\"un_crumbs\" id=\"un_serchtop\">\r\n");
      out.write("\t               <div class=\"vi_search\">\r\n");
      out.write("\t                \t<input type=\"text\" placeholder=\"请输入区域名称\" id='searchInput' value=\"\"><span class=\"vi_del\"></span><span class=\"vi_seph\"></span>\r\n");
      out.write("\t               </div>      \r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"left_list\">\r\n");
      out.write("\t\t\t\t<div class='showNoneInfo' style='display:none'>没有相关区域信息</div>\r\n");
      out.write("\t\t\t\t<ul class=\"left_list_ul\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<a class=\"switch\" href=\"javascript:void(0);\"></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"rightBox\">\r\n");
      out.write("\t\t\t\t<div class=\"crumbs sanwangbox\">\r\n");
      out.write("\t\t\t\t\t");
if(!"hide".equals(InitParam.DATA_SOURCE)){ 
      out.write("\r\n");
      out.write("\t\t\t\t    <p class=\"sanwang dn\"><span class=\"btnOn\" id=\"ydSpan\"><a id=\"ydA\">移动</a></span><span id=\"qwSpan\"><a id=\"qwA\">全网</a></span></p>\r\n");
      out.write("\t\t\t\t    <p class=\"sanwang2 dn\"></p>\r\n");
      out.write("\t\t\t\t\t<a onmouseout=\"hideSpanTime();\" onmouseover=\"showSpanTime();\" onclick=\"reload();\" class=\"xjia dn\"></a>\r\n");
      out.write("\t\t\t\t\t<p id=\"new_date\" class=\"sanwangdate dn\"><span id=\"spanName\">数据更新时间：</span><span id=\"spanTime\"></span></p>\r\n");
      out.write("\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t<div style='display:none'>\r\n");
      out.write("\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t您当前位置：<span id='proveSpan' style='cursor: pointer'>");
      out.print(InitParam.DEPLOY_PROVINCE_NAME);
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t<!-- 地市 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<a class=\"link_bar\" id='cityLevel'>全部</a>\r\n");
      ...
      out.write("\t\t\t\t\t\t<p>&nbsp;&gt;&nbsp;</p>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"crumbs_link\">\r\n");
      out.write("\t\t\t\t\t\t\t<a class=\"link_bar\" id='countyLevel'>全部</a>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"cityTabs\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"citytabsDiv minHeight\" id='countySelect'></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- 区域 -->\r\n");
      out.write("\t\t\t\t\t\t<p>&nbsp;&gt;&nbsp;</p>\r\n");
      out.write("\t\t\t\t\t\t<div id='showLeaderDiv' class=\"crumbs_link\">\r\n");
      out.write("\t\t\t\t\t\t\t<a class=\"link_bar\" id='regionLevel'>全部</a>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"cityTabs\" id='onlyRegion'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul class=\"minHeight\" id='regionSelect'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"areaSelect unknowm_map\"  id=\"unknown_map_region\">\r\n");
      ...
      out.write("\t\t\t                \t当前选择：<span id=\"un_city_name_span\"></span>\r\n");
      out.write("\t\t\t                </div>\r\n");
      out.write("\t\t\t                <div class=\"un_city_btn\">\r\n");
      out.write("\t\t                    \t<a href=\"javascript:void(0);\" id=\"un_city_all_prov\" class=\"big_city\" style=\"display: none;\" nm=\"");
      out.print(InitParam.DEPLOY_PROVINCE_NAME);
      out.write('"');
      out.write('>');
      out.print(InitParam.DEPLOY_PROVINCE_NAME);
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"map loadingBig\" id='map'></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- 数据概况 -->\r\n");
      out.write("<div class=\"pop_quyu\" style=\"display: none;\">\r\n");
      out.write("    <div style=\"background-color:#E1EFFC \">\r\n");
      out.write("    <div style=\"float: right;\">\r\n");
      out.write("\t\t<img id=\"close_view\" class=\"csp\" src=\"../dtkl/assets/css/images/close_view.png\"/>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div style=\"color: #4ECAEE;margin-left: 350px;font-size: 16px;\">全网数据概况</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<br/>\r\n");
      out.write("    <h2 class=\"time_new_div\"></h2>\r\n");
      out.write("\t<ul>\r\n");
      out.write("   \t \t<li>\r\n");
      out.write("    \t\t<span style=\"color: #4ECAEE;\">数据趋势图</span>\r\n");
      out.write("        \t<div class=\"xiantu\" id=\"xiantu\" style=\"margin-top:-13px;\"></div>\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li class=\"last_li\">\r\n");
      out.write("    \t\t<span style=\"color: #4ECAEE;\">客流量占比</span>\r\n");
      out.write("        \t<div class=\"bingtu\" id=\"bingtu\" style=\"margin-top: -32px;margin-left: 10px;\"></div>\r\n");
      out.write("   \t\t</li>\r\n");
      out.write("        \r\n");
      out.write("\t</ul>\r\n");
      out.write("    <p class=\"tixing\"  style=\"margin-left: 630px;\"><input onclick=\"addCookie();\" type=\"checkbox\" id=\"tingxingCheck\">不再提醒 </p>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
